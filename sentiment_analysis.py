...
Original file is located at
    https://colab.research.google.com/drive/12dhD6w5rWMQB7jPIEw-aozK-Qmu23ZZq#scrollTo=fWm-RtexFHuK
"""
...
# reading of the data
df = pd.read_csv('C:\Users\ADMIN\OneDrive\Desktop\aa\Reviews.csv')
print(df.shape)
df = df.head(500)
print(df.shape)
